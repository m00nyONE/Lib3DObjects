...
function BaseObjectGroup:EnableVisualReferencePoint()
    ...
    visualRefPoint:ShowPosition(true)
    visualRefPoint:SetColor(1, 1, 0, 1)
    visualRefPoint:AddCallback(function(marker, distanceToPlayer, distanceToCamera)
